	...
	<div class="container">
		...
		<div class="col-lg-4" >
			<div class="jumbotron" style="padding-top: 20px">
				<form method="post" action="managerRegisterAction.jsp">
					<h3 style="text-align: center;">회원가입</h3>					
					<div class="form-group">
						<input type="text" class="form-control" placeholder="아이디" name="managerID" maxlength="20" value="manager" readonly="readonly">
					</div>
					<div class="form-group">
						<input type="password" class="form-control" placeholder="비밀번호" name="managerPassword" maxlength="20">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" placeholder="이름" name="managerName" maxlength="20">
					</div>
					...
					<div class="form-group">
						<input type="email" class="form-control" placeholder="이메일" name="managerEmail" maxlength="20">
					</div>	
					<div class="form-group">
                        <label>휴대폰 번호('-' 빼고 입력)</label>
                        <input type="tel" class="form-control" name="phoneNumber" placeholder="휴대폰번호를 입력해 주세요" >
                    </div>		
