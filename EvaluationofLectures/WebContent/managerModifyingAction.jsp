...
<%
	...
	if (managerID == null || managerPassword == null || managerEmail == null || managerName == null || phoneNumber == null || managerID.equals("") || managerPassword.equals("")
		...
		int result = managerDAO.modifyData(new ManagerDTO(managerID, managerPassword, managerName, managerGender, managerEmail, phoneNumber, SHA256.getSHA256(managerEmail), false));
		...
		if (result == -1) {
			...
			PrintWriter script = response.getWriter();
			script.println("<script>");
			script.println("location.href='managerEmailSendReAction.jsp'");
			script.println("</script>");
			script.close();
		}
	}
