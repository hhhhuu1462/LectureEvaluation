...
public class EvaluationDTO {
	...
	private int evaluationAvailable;
	...
	public int getEvaluationAvailable() {
		return evaluationAvailable;
	}
	public void setEvaluationAvailable(int evaluationAvailable) {
		this.evaluationAvailable = evaluationAvailable;
	}
	
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String professorName, String lectureYear,
			String semesterDivide, String lectureDivide, String evaluationTitle, String evaluationDate,
			String evaluationContent, String totalScore, String creditScore, String comfortableScore,
			String lectureScore, int likeCount, int evaluationAvailable) {
		super();
		this.evaluationID = evaluationID;
		this.userID = userID;
		this.lectureName = lectureName;
